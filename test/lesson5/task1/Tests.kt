...
class Tests {
    ...
    fun bagPacking() {
        ...
        assertEquals(
            setOf("4", "3"),
            bagPacking(
                mapOf("0" to (1 to 1), "1" to (1 to 1), "2" to (1 to 1), "3" to (1 to 2), "4" to (1 to 2)),
                2
            )
        )
        ...
        assertEquals(
            setOf("5", "3", "2", "1", "0"),
            bagPacking(
                mapOf("0" to (1 to 1), "1" to (10 to 2), "2" to (1 to 1), "3" to (148 to 2), "4" to (153 to 1), "5" to (149 to 2)),
                458
            )
        )
    }
